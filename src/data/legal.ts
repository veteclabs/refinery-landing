...
const company = {
  ...
  mailOrderNo: '',
  /**
   * 본점 소재지 — 국문 · 영문 모두 도로명이다(2026-09-11 국문을 지번 '관평동 1311'에서 바꿨다).
   * 두 값 모두 사용자가 준 표기 그대로 둔다 — 국문은 도로명을 붙여 쓰고 괄호 속 법정동을 붙인다.
   * 국문은 HTML이다(<Ph html>): 도로명과 건물번호 '테크노3로 24'를 한 덩어리로 묶고 '(관평동)' 앞에만
   * 줄바꿈 자리를 둔다. 없으면 사업자 정보 칸(272px)에서 '테크노3로 / 24(관평동)'으로 번호가 떨어졌다.
   */
  address: { ko: '대전광역시 유성구 <span class="legal-keep">테크노3로 24</span><wbr>(관평동)', en: '24, Techno 3-ro, Yuseong-gu, Daejeon, Korea' },
