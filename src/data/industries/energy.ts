...
export const energy: IndustryData = {
  ...
  architecture: {
    ...
    steps: [
      { label: '현장', detail: '발전 · 변전 설비 · 스마트미터 · 센서', icon: 'ph-broadcast' },
      { label: '연동', detail: 'SCADA · EMS · Modbus · OPC-⁠UA · DNP3 · IEC 61850', icon: 'ph-plugs-connected' },
      { label: 'Refinery', detail: '온톨로지 · AI 에이전트 · 룰⁠/⁠자동화', icon: 'ph-sparkle', highlight: true },
      { label: '활용', detail: '통합 대시보드 · 알람 · ESG 리포트', icon: 'ph-monitor' },
    ],
