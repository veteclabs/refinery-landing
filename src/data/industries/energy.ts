...
export const energy: IndustryData = {
    ...
    items: [
      {
        title: '데이터가 흩어져 있다',
        description:
          '발전 설비 · 변전 · 미터 데이터가 SCADA · EMS · 과금 시스템에 분산되어 <br>전체 현황을 한눈에 보기 어렵습니다.',
      },
      {
        title: '고장을 사후에 안다',
        description:
          '설비 이상이 정지 · 사고로 이어진 뒤에야 파악되는 경우가 많아 <br>예방적 대응이 어렵습니다.',
      },
      {
        title: 'ESG · 규제 리포트가 수작업이다',
        description:
          '탄소 배출 · 에너지 소비 집계와 규제 리포트를 사람이 취합해 <br>시간이 걸리고 오류 여지가 큽니다.',
      },
      {
        title: '실시간 대응이 늦다',
        description:
          '수요 · 요금 · 기상 변동에 맞춰 소비를 조정하려면 여러 화면과 판단이 필요해 <br>대응이 지연됩니다.',
      },
    ],
  },
  useCases: {
  ...
  architecture: {
    ...
    steps: [
      { label: '현장', detail: '발전 · 변전 설비 · 스마트미터 · 센서', icon: 'ph-broadcast', image: '/flow/site.svg' },
      { label: '연동', detail: 'SCADA · EMS · Modbus · OPC-⁠UA · DNP3 · IEC 61850', icon: 'ph-plugs-connected', image: '/flow/connect.svg' },
      { label: 'Refinery', detail: '온톨로지 · AI 에이전트 · 룰⁠/⁠자동화', icon: 'ph-sparkle', highlight: true, image: '/flow/refinery.svg' },
      { label: '활용', detail: '통합 대시보드 · 알람 · ESG 리포트', icon: 'ph-monitor', image: '/flow/use.svg' },
    ],
