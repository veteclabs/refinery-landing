    ...
    items: [
      {
        ...
        description:
          '전력 ⁠· LNG ⁠· 스팀 ⁠· 수도가 함께 들어가는데 각각 따로 집계돼 <br>전체 그림이 잡히지 않습니다.',
      },
      {
        title: '작은 변화가 품질과 생산 안정성을 흔든다',
        description:
          '반응기 ⁠· 보일러 ⁠· 송풍기 ⁠· 압축기가 연속 운전되며 공정 조건의 <br>작은 변화가 곧장 결과로 이어집니다.',
      },
      {
        title: '공정 변수의 정밀 제어가 필수다',
        description:
          '공기비 ⁠· 온도 ⁠· 압력 ⁠· 유량을 동시에 맞춰야 하는데 사람의 <br>감으로는 최적점을 유지하기 어렵습니다.',
      },
      {
        title: '에너지 비용과 탄소 규제가 함께 조인다',
        description:
          '단순 모니터링을 넘어 목표 기반 에너지 관리와 공정 효율 <br>최적화가 요구되고 있습니다.',
      },
    ],
  },
  useCases: {
