    ...
    items: [
      {
        title: '열매체 순환 효율',
        description:
          '열매체가 도는 경로마다 손실이 다른데 <br>어디서 새는지 드러나지 않습니다.',
      },
      {
        title: '연소 공기비',
        description:
          '보일러 공기비가 최적에서 벗어나도 <br>연료가 얼마나 낭비되는지 보이지 않습니다.',
      },
      {
        title: '반응기 부하 편차',
        description:
          '같은 반응인데 반응기마다 부하가 갈리고 <br>비교할 기준이 없습니다.',
      },
      {
        title: '부하 대비 에너지 투입 편차',
        description:
          '반응 공정 부하와 실제 에너지 투입이 어긋나도 <br>지나고 나서야 확인됩니다.',
      },
      {
        title: '배출량 이상 징후',
        description:
          '배출량이 평소와 달라져도 집계가 사람 손을 거쳐 <br>알아채는 데 시간이 걸립니다.',
      },
    ],
  },
  useCases: {
    ...
    items: [
      ...
      },
      {
        ...
        approach: '압축기 상태와 운전 인자를 함께 추적해 평소와 다른 흐름을 짚어냅니다.',
