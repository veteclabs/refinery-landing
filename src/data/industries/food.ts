...
export const food: IndustryData = {
  ...
  challenges: {
    ...
    items: [
      {
        title: '냉동 · 냉장 설비 효율 저하 구간',
        description:
          '설비 성능이 서서히 나빠져도 <br>어느 구간부터 떨어졌는지 드러나지 않습니다.',
      },
      {
        title: '압축공기 누설 및 과다 운전',
        description:
      ...
      },
      {
        title: '배치별 에너지 사용 편차',
        description:
          '같은 제품인데 배치마다 에너지 사용이 갈리고 <br>비교할 기준이 없습니다.',
      },
      {
        title: 'CIP 세정 구간 에너지 집중',
        description:
          '세정 구간에 에너지가 몰리는데 <br>생산과 따로 집계돼 원가에 묻힙니다.',
      },
      {
        title: '품질 온도 이탈 감시',
        description:
          '보관 · 이송 온도가 기준을 벗어나도 <br>제품이 나온 뒤에야 확인됩니다.',
      },
    ],
  },
  useCases: {
    ...
    items: [
      ...
      },
      {
        ...
        approach: '진동 데이터에서 평소와 다른 패턴을 학습해 이상 징후를 조기에 포착합니다.',
