    ...
    items: [
      {
        ...
        description:
          '공기압축기 · 냉동기 · 보일러 · 스팀 설비 비중이 높아 효율이 <br>떨어지면 비용과 품질 리스크로 바로 이어집니다.',
      },
      {
        title: '생산이 멈추면 손실 규모가 크다',
        description:
          '위생 기준과 품질 규제가 엄격해 한 번의 중단이 큰 <br>손실로 남습니다.',
      },
      {
        title: '배치마다 에너지 사용 패턴이 달라진다',
        description:
          '배치 생산 구조라 생산량이 흔들리면 에너지 사용도 <br>함께 갈립니다.',
      },
      {
        title: '원가 · 탄소 · 노후화가 동시에 온다',
        description:
          '원가 압박과 탄소 규제 대응, 설비 노후화가 같은 시기에 <br>겹치고 있습니다.',
      },
    ],
  },
  useCases: {
