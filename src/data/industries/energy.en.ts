...
export const energyEn: IndustryData = {
  ...
  architecture: {
    ...
    steps: [
      { label: 'Site', detail: 'Generation and substation assets · smart meters · sensors', icon: 'ph-broadcast' },
      { label: 'Connect', detail: 'SCADA · EMS · Modbus · OPC-⁠UA · DNP3 · IEC 61850', icon: 'ph-plugs-connected' },
      { label: 'Refinery', detail: 'Ontology · AI agent · rules and automation', icon: 'ph-sparkle', highlight: true },
      { label: 'Use', detail: 'Unified dashboard · alerts · ESG reports', icon: 'ph-monitor' },
    ],
