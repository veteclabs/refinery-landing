    ...
    items: [
      {
        ...
        description:
          '열처리로 ⁠· 압축공기 ⁠· 냉각수 ⁠· 성형 장비가 연속으로 돌며 작은 <br>조건 차이가 제품에 그대로 남습니다.',
      },
      {
        title: '열처리는 설비 안정성과 에너지 제어를 함께 요구한다',
        description:
          '온도 ⁠· 유지 시간 ⁠· 냉각 조건이 소재 특성을 정하기 때문에 둘 중 <br>하나만 맞춰서는 재현되지 않습니다.',
      },
      {
        title: '에너지 흐름이 복잡하고 피크가 자주 튄다',
        description:
          '에너지가 공정마다 흩어져 흐르는 데다 고온 ⁠· 대전력 설비가 <br>겹쳐 돌아 과소비 구간을 짚기도, 최대 수요를 잡기도 어렵습니다.',
      },
    ],
  },
  useCases: {
