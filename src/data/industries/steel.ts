    ...
    items: [
      {
        title: '열처리 온도 유지 패턴',
        description:
          '온도 · 유지 시간의 작은 차이가 <br>소재 특성을 그대로 바꿉니다.',
      },
      {
        title: '냉각 곡선 이탈',
        description:
          '냉각 구간이 기준을 벗어나도 <br>결과물이 나온 뒤에야 확인됩니다.',
      },
      {
        title: '압축공기 피크',
        description:
      ...
      },
      {
        title: '최대수요 전력 급증 구간',
        description:
          '고온 · 대전력 설비가 겹쳐 돌면서 <br>최대 수요가 급증해 요금 부담이 커집니다.',
      },
      {
        title: '공정별 에너지 분산',
        description:
          '에너지가 공정마다 흩어져 있어 <br>어느 구간이 과소비인지 분리해 보기 어렵습니다.',
      },
    ],
  },
  useCases: {
