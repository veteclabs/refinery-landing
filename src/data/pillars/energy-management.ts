...
export const energyManagement: PillarContent = {
  ...
  heroTitle: '에너지관리시스템(EMS)이란?',
  heroLede: 'EMS·BEMS·전력관리시스템·전력감시·정전감시를 정리했습니다. Refinery는 전력·에너지 데이터를 온톨로지로 엮어, AI가 근거를 들어 이상과 절감 기회를 찾습니다.',
  ctaPrimary: '문의하기',
  contactHref: '/contact',
  ctaGhost: '플랫폼 개요',
  ...
  faq: [
    {
      ...
      a: '에너지관리시스템(EMS, Energy Management System)은 공장·건물의 전력·가스·열 등 에너지 사용을 \n실시간으로 계측·분석해 소비를 줄이고 효율을 높이는 시스템입니다. \n사용 현황을 가시화하고 낭비와 이상을 찾아 절감으로 잇습니다.',
    },
    {
    ...
    {
      q: '전력관리시스템이란 무엇인가요?',
      a: '전력관리시스템은 수전·분전 계통의 전압·전류·전력·역률을 실시간으로 수집·분석해 \n전력 사용을 감시하고 최적화하는 시스템입니다. 피크 수요와 이상 부하를 관리해 \n전력 요금과 정전 위험을 줄입니다.',
    },
    {
      q: '전력감시·전력모니터링은 무엇인가요?',
      a: '전력감시(전력모니터링)는 수배전 계통의 전기 데이터를 실시간으로 지켜보며 \n이상을 조기에 감지하는 것을 말합니다. 전압 강하·과부하·역률 저하 같은 징후를 \n알람으로 알려 사고를 예방합니다.',
    },
    {
      q: '정전감시는 어떻게 하나요?',
      a: '정전감시는 전원 이상이나 정전을 즉시 감지해 알리는 기능입니다. 계통의 전압·전류를 상시 \n모니터링해 전원이 끊기거나 불안정해지는 순간을 포착하고, 담당자에게 실시간으로 통보합니다.',
    },
    {
      q: 'Refinery의 에너지·전력 관리는 무엇이 다른가요?',
      a: 'Refinery는 EMS·전력 계측·설비 데이터를 온톨로지로 하나로 엮어, 흩어진 지표를 맥락과 함께 봅니다. \nAI가 피크와 이상의 원인을 근거를 들어 설명하고 조치를 제안하며, \n데이터가 사내를 벗어나지 않는 온프레미스 배포를 지원합니다.',
    },
  ],
  uses: [
