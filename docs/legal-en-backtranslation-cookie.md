...
| 11 | 회사는 맞춤형 광고를 제공하지 않으며, 제3자 광고사업자가 본 웹사이트에서 행태정보를 수집하도록 허용하지 않습니다. | We do not provide personalized advertising and do not allow third-party advertising companies to collect behavioral information on this website. | 저희는 맞춤형 광고를 제공하지 않으며, 제3자 광고 회사가 본 웹사이트에서 행태정보를 수집하는 것을 허용하지 않습니다. | 일치 |
