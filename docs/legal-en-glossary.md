...
| Q2 | 이용약관 제8조 제3호가 인용한 정보통신망법 제50조의2는 2014. 5. 28. 삭제된 조문이다(KLRI 영문본 · 국가법령정보센터 현행 국문 "제50조의2 삭제 <2014. 5. 28.>" 모두 확인). 본문 작성 담당자 확인 전까지 원문 유지(2026-09-11 사용자 결정). 인용을 빼거나 현행 조문(예: 제50조 제5항)으로 바꿔야 하는가? 한국어판을 고치면 영어판도 같이 고친다 | 이용약관 KLRI 대조 (2026-09-11) |
