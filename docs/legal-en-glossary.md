...
| 딸림글 | ※ 표시 | **Note:** 머리말 | ※의 뜻(참고)을 영어 낱말로 옮긴 것. ※는 한 · 중 · 일 관용 기호라 영어 독자가 모른다. 한국어판이 ※를 단 이유(글만으로는 앞뒤 문단과 안 갈린다)는 영어에도 있어 빼지 않는다. `legal.css`의 `:lang(en)` 규칙 · 2026-09-11 사용자 확정 |
