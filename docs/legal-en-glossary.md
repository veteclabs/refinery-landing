...
| `company.address` | 대전광역시 유성구 테크노 3로 24 (관평동) | 24, Techno 3-ro, Yuseong-gu, Daejeon, Korea | ✅ 2026-09-11 확인 — 아래 주의 |
...
> 도로명 `대전광역시 유성구 테크노 3로 24 (관평동)`으로 바꿨다(2026-09-11, 사용자가 준 표기 그대로).
